...
import NetworkCommandCenter from '../pages/network/NetworkCommandCenter'
...
import RouterWorkspace from '../pages/routers/RouterWorkspace'
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/network-command" element={<NetworkCommandCenter />} />
