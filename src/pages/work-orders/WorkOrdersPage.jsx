  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Manage work orders, installations, and field service</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white p-6 rounded-lg border border-gray-200">
            ...
            <div className="text-sm text-gray-600 mt-1">Total Work Orders</div>
          </div>
          <div className="bg-white p-6 rounded-lg border border-gray-200">
      ...
      {stats && stats.by_type && stats.by_type.length > 0 && (
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <h2 className="text-lg font-semibold mb-4">Work Orders by Type</h2>
      ...
      {stats && stats.by_priority && stats.by_priority.length > 0 && (
        <div className="bg-white p-6 rounded-lg border border-gray-200">
          <h2 className="text-lg font-semibold mb-4">Work Orders by Priority</h2>
